              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"
                    />
                  </svg>
                </button>
            ...
            {polls.length === 0 && (
              ...
              >
                ...
                <p className="text-[#99AAB5] max-w-sm mb-6">
                  {debouncedSearch
                    ? "We couldn't find any polls matching your search criteria. Try clearing your filters."
                    : "You haven't created any interactive polls for this server yet. Set one up to get feedback from your team!"}
                </p>
                {!debouncedSearch && (
                  <button
                    onClick={() => setIsModalOpen(true)}
                    className="bg-[#5865F2] hover:bg-[#4752C4] text-white px-6 py-2 rounded-md 
          ...
          {totalPages > 1 && (
            <div className="flex justify-center items-center gap-4 mt-10">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-white text-sm font-bold bg-[#1e1f22] px-3 py-1.5 rounded border border-[#3f4147]">
                  {page}
                </span>
