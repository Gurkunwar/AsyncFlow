...
export default function CreateStandupModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
      <div
        className="bg-[#313338] w-full max-w-4xl rounded-xl border border-[#1e1f22] shadow-2xl flex 
              ...
              <div className="space-y-6 animate-fade-in">
                        ...
                        >
                          <span
                            className={`text-sm font-semibold truncate ${
                              g.bot_present ? "text-white" : "text-[#99AAB5]"
                            }`}
                          >
                            {g.name}
                          </span>
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  <div
                    ...
                    className={`w-full bg-[#1e1f22] p-3 rounded-md flex items-center justify-between text-sm 
                      ${!formData.guild_id ? "opacity-50" : "cursor-pointer text-white"}`}
                  >
                    <span>
                  ...
                  {isChannelDropdownOpen && (
                    ...
                    shadow-xl max-h-40 overflow-y-auto py-1"
                    >
                      {channels.map((c) => (
                        <div
                          key={c.id}
                          ...
                          className="px-3 py-2 text-sm text-[#99AAB5] hover:bg-[#35373c] hover:text-white 
                          cursor-pointer"
                        >
                          # {c.name}
                        </div>
              ...
              <div className="space-y-6 animate-fade-in">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#99AAB5] mt-2">
                    Team members will receive DMs at this time in their local
                    timezone.
                  </p>
                </div>
              ...
              <div className="space-y-4 animate-fade-in flex flex-col h-full">
                          ...
                          >
                            {(provided, snapshot) => (
                              <div
                                ...
                                className={`
                                flex items-center gap-3 bg-[#1e1f22] p-3 rounded-md border ${
                                  snapshot.isDragging
                                    ? "border-[#5865F2] shadow-xl"
                                    : "border-transparent"
                                }`}
                              >
                                <div
                                  {...provided.dragHandleProps}
                                  className="text-[#404249] cursor-grab px-1"
                                >
                                  <svg
                                    width="10"
                                    height="16"
                ...
                {formData.questions.length < 5 && (
                  <button
                    type="button"
                    onClick={addQuestion}
                    className="text-sm text-[#5865F2] hover:text-[#4752C4] font-bold text-left"
                  >
