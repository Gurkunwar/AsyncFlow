...
var Commands = []*discordgo.ApplicationCommand{
	...
	{
		Name:        "admin-trigger-summary",
		Description: "🔒 Admin only: Force trigger the monthly standup summaries",
		Options: []*discordgo.ApplicationCommandOption{
			{
				Type:         discordgo.ApplicationCommandOptionString,
				Name:         "standup_name",
				Description:  "The exact name of the standup to summarize",
				Required:     false,
				Autocomplete: true,
			},
			{
				Type:        discordgo.ApplicationCommandOptionUser,
				Name:        "user",
				Description: "The user to get a summary for",
				Required:    false,
			},
			{
				Type:        discordgo.ApplicationCommandOptionInteger,
